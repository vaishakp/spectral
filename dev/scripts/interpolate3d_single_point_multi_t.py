...
if mpi_rank==0:
    ...
    message(f"Ang Coord values Theta{theta_grid[index_x, index_y]} Phi{phi_grid[index_x, index_y]}")
else:
    index_x = None
    index_y = None
...
one_set_of_coords = np.array([[r_grid[index_x, index_y],], [theta_grid[index_x, index_y],], [phi_grid[index_x, index_y],]])
